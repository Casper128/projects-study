SubProceso imprimir ( nom1,nom2,nom3,tel1,tel2,tel3,org1,org2,org3 )
...
SubProceso bandera<-ValidarTelefono(tel1,tel2,tel3,telDigitado)
	si tel1==telDigitado | tel2==telDigitado | tel3==telDigitado Entonces
		bandera<-verdadero;
	Finsi
FinSubProceso

SubProceso buscado(buscar,nom1,nom2,nom3,tel1,tel2,tel3,org1,org2,org3)
...
Proceso Punto6Taller2
	...
	Repetir
		...
		Escribir "3.Eliminar contacto por nombre";
		...
		Segun opcion hacer	
			1: Escribir "Por favor Digite su nombre: ";
				si nom1=="" Entonces
					...
					Leer telDigitado;
					si ValidarTelefono(tel1,tel2,tel3,telDigitado)==verdadero Entonces
			...
			2: Escribir "Por favor Digite el contacto que busca: ";
				Leer buscar;
				buscado(buscar,nom1,nom2,nom3,tel1,tel2,tel3,org1,org2,org3);
		...
		FinSegun
		imprimir(nom1,nom2,nom3,tel1,tel2,tel3,org1,org2,org3);
	Hasta Que opcion==0	
