SubProceso  buscado (nom1,nom2,nom3,nom4,nom5,nom6,nom7,nom8,puntuacion1,puntuacion2,puntuacion3,puntuacion4,puntuacion5,puntuacion6,puntuacion7,puntuacion8 )
	...
	FinSi
FinSubProceso
SubProceso  consultar (nom1,nom2,nom3,nom4,nom5,nom6,nom7,nom8,ingre1,ingre2,ingre3,ingre4,ingre5,ingre6,ingre7,ingre8,puntuacion1,puntuacion2,puntuacion3,puntuacion4,puntuacion5,puntuacion6,puntuacion7,puntuacion8 )
	Escribir "Usuarios que han realizado el curso y su puntuacion: ";
	si ingre1==verdadero Entonces
		Escribir "Nombre Cliente 1: ",nom1," Realizo el curso puntuacion: ",puntuacion1;
	FinSi
	si ingre2==verdadero Entonces
		Escribir "Nombre Cliente 2: ",nom2," Realizo el curso puntuacion: ",puntuacion2;
	FinSi
	si ingre3==verdadero Entonces
		Escribir "Nombre Cliente 3: ",nom3," Realizo el curso puntuacion: ",puntuacion3;
	FinSi
	si ingre4==verdadero Entonces
		Escribir "Nombre Cliente 4: ",nom4," Realizo el curso puntuacion: ",puntuacion4;
	FinSi
	si ingre5==verdadero Entonces
		Escribir "Nombre Cliente 5: ",nom5," Realizo el curso puntuacion: ",puntuacion5;
	FinSi
	si ingre6==verdadero Entonces
		Escribir "Nombre Cliente 6: ",nom6," Realizo el curso puntuacion: ",puntuacion6;
	FinSi
	si ingre7==verdadero Entonces
		Escribir "Nombre Cliente 7: ",nom7," Realizo el curso puntuacion: ",puntuacion7;
	FinSi
	si ingre8==verdadero Entonces
		Escribir "Nombre Cliente 8: ",nom8," Realizo el curso puntuacion: ",puntuacion8;
	FinSi		
FinSubProceso
...
Proceso sin_titulo
	...
	Repetir
		...
		Segun opcion hacer	
			...
			2: 	
				consultar(nom1,nom2,nom3,nom4,nom5,nom6,nom7,nom8,ingre1,ingre2,ingre3,ingre4,ingre5,ingre6,ingre7,ingre8,puntuacion1,puntuacion2,puntuacion3,puntuacion4,puntuacion5,puntuacion6,puntuacion7,puntuacion8 );
			3: Escribir "Digite el Cliente que desea consultar";
				Leer buscar;
				buscado(nom1,nom2,nom3,nom4,nom5,nom6,nom7,nom8,puntuacion1,puntuacion2,puntuacion3,puntuacion4,puntuacion5,puntuacion6,puntuacion7,puntuacion8 );
