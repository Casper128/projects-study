class Grafo:
    ...
    def fillMatrix(self):
        ...
        for i in range(self.__rows):
            ...
            for j in range(cols):
                ...
                if self.__rows == cols and i == j and inputValueNode != 0:
                    print(
                        "The value of this position does not match an adjacency matrix")
                    return
        ...
        if self.__rows == cols:
            print('\n')
            print("Adjacency Matrix: ", self.__matrix)
            print("Adjacencies of each vertex: ", arrayAux2)
        else:
            print('\n')
            print("Incidence Matrix: ", self.__matrix)
            print("Incidents of each vertex: ", arrayAux2)
